...
class AnimatedFuelTank extends StatefulWidget {
  ...
  @override
  State<AnimatedFuelTank> createState() => _FuelTankAnimation();
}

class _FuelTankAnimation extends State<AnimatedFuelTank>
    ...
    return Stack(
      children: [
        ...
        SizedBox(
          ...
          width: widget.width,
          child: CustomPaint(
            painter: FuelTankPainter(isActive: widget.isActive),
          ),
        ),
      ],
    );
...
class FuelTankPainter extends CustomPainter {
  FuelTankPainter({required this.isActive});
  final bool isActive;

  ///
  /// El cuerpo del cilindro y sus detalles.
  ///
  ...
  ///
  /// La sombra del cilindro en la parte inferior.
  ///
  ...
  ///
  /// La tapa inicial del cilindro.
  ///
  void _drawInitialCap(Canvas canvas, Size size) {
  ...
  ///
  /// El óvalo frontal del cilindro.
  ///
  void _drawFrontOval(Canvas canvas, Size size) {
  ...
  ///
  /// El final del cilindro.
  ///
  void _drawEndCylinder(Canvas canvas, Size size) {
  ...
  ///
  void _drawCaps(Canvas canvas, Size size, bool isActive) {
    void drawShape(
      Canvas canvas,
      Path path,
      Offset offset,
    ...
    drawShape(canvas, path1, centerOffset1, scaleFactor1, size);
    ...
    drawShape(canvas, path2, centerOffset2, scaleFactor2, size);
  ...
  ///
  void _drawCylinderBases(Canvas canvas, Size size) {
    void drawBase(
      Canvas canvas,
      Path pathLeft,
      Offset offset,
  ...
  void paint(Canvas canvas, Size size) {
    _drawCylinderBody(canvas, size);
    _drawInitialCap(canvas, size);
    _drawFrontOval(canvas, size);
    _drawEndCylinder(canvas, size);
    _drawCaps(canvas, size, isActive);
    _drawShadow(canvas, size);
    _drawCylinderBases(canvas, size);
  }
...
class OndasWater extends CustomPainter {
  OndasWater({
    required this.tankColor,
    required this.fuelLevel,
  ...
  @override
  bool shouldRepaint(OndasWater oldDelegate) {
